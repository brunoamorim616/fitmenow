...
export function InputText({placeHolderText}: InputTextProps) {
  ...
  return (
    <View marginY={2} position={'relative'} top={0} left={0} right={0} bottom={0} width={'100%'} justifyContent={'center'}>
      <Input
      ...
      <Animated.View style={{ 
        ...
        alignItems: 'center',
        position: 'absolute',left: 20 , bottom: 3, top: 0,
        transform: [
        ...
        <Animated.Text style={{
          ...
          textAlign:'left',
          opacity: fadeAnim, 
          position: 'relative',right: 0, left: 0 }}>{placeHolderText}</Animated.Text>
      </Animated.View>
    </View>
  );
}